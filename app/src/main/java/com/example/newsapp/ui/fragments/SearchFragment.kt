...
class SearchFragment : Fragment(R.layout.fragment_search) {
            ...
            when (response) {
                is Resource.Success<*> -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        isLastPage = newsViewModel.searchPage == totalPage
                        if (isLastPage) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isAtLastItem = firstVisibleItemPositions + visibleItemCount >= totalItemCount
            val isNotAtBeginning = firstVisibleItemPositions >= 0
